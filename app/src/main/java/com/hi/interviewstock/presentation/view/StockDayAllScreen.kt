...
import com.hi.interviewstock.presentation.viewmodel.StockDayAllViewModel


@Composable
fun StockDayAllScreen(viewModel: StockDayAllViewModel = hiltViewModel()) {
    ...
    LazyColumn(modifier = Modifier.fillMaxSize().padding(16.dp)) {
        items(items.value.size) { index ->
            ...
            Column(Modifier.padding(8.dp)) {
                ...
                BasicText("Yield Rate: ${item.TradeVolume}")
            }
        }
    }
